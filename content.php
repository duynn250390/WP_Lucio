                    ...
                    <div class="box_right box_control">
                        ...
                        <article class="descrption_product">
                            <p>Go sporty this summer with this vintage navy and white striped v-neck t-shirt from the
                                Nike. Perfect for pairing with denim and white kicks for a stylish sporty vibe.</p>
                        </article>
                                    ...
                                    <div class="box_info_customer">
                                        <div class="box_gender form_control">
                                            <div class="item_gender check_control">
                                                <input type="radio" name="gender" id="check_gender_male"
                                                    class="check_order_in">
                                                <span class="checkmark"></span>
                                                <label for="check_gender_male" class="check_order_label">Anh</label>
                                            </div>
                                            <div class="item_gender check_control">
                                                <input type="radio" name="gender" id="check_gender_female"
                                                    class="check_order_in">
                                                <span class="checkmark"></span>
                                        ...
                                        <div class="form_control">
                                            <div class="haft_box">
                                                <input class="in_control" type="text" placeholder="Họ tên người mua"
                                                    name="ho_ten" />
                                            </div>
                                            <div class="haft_box">
                                                <input class="in_control" type="text" placeholder="Thông tin Email"
                                                    name="email" />
                                            </div>
                                        </div>
                                        <div class="form_control">
                                            <div class="haft_box">
                                                <input class="in_control" type="text"
                                                    placeholder="Số điện thoại liên hệ" name="phone" />
                                            </div>
                                            <div class="haft_box">
                                                <input class="in_control" type="text" placeholder="Địa chỉ"
                                                    name="dia_chi" />
                                            </div>
                                        </div>
                                        <div class="form_control">
                                            <div class="full_box">
                                                <textarea class="in_control" rows="5" name="ghi_chu"
                                                    placeholder="Thông tin ghi chú"></textarea>
                                            </div>
                                        </div>
                                    </div>
